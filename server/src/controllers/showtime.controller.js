...
const addShowtime = asyncHandler(async (req, res) => {
  ...
  return res.status(201).json(new ApiResponse(201, { 
    ...
    seatAvailability: {
      ...
      message: "Seat availability created successfully"
    }
  }, "Showtime and seat availability created successfully"));
});
...
const deleteShowtime = asyncHandler(async (req, res) => {
  ...
  return res
    ...
    .json(new ApiResponse(200, { 
      ...
      seatAvailability: {
        deletedCount: deletedSeatAvailability.deletedCount,
        message: "Seat availability records deleted successfully"
      }
    }, "Showtime and associated seat availability deleted successfully"));
});

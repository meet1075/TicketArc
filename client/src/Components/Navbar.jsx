...
//             <a href="/" className="flex items-center space-x-1 hover:text-red-500 transition-colors">Home</a>
...
import { User, Ticket, LogIn, Menu, X } from 'lucide-react';
import logo from "../assets/image/logo.png";
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className={`absolute md:static top-16 left-0 w-full md:w-auto bg-black gap-5 md:bg-transparent p-4 md:p-0 transition-all duration-300
            ...
            {isLoggedIn ? (
              ...
              <a href="/login" className="flex items-center space-x-1 bg-red-500 hover:bg-red-600 px-4 py-2 rounded-md transition-colors">
                <LogIn size={16} />
                <span>Login</span>
              </a>
            )}
